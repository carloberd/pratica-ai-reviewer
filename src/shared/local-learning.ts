 ...
 *
 * Sta qui e non accanto alla firma in `template-fingerprint.ts`: quel modulo importa
 * `node:crypto`, e il renderer, che legge questo file, non lo può caricare. Da là qui
 * passano solo tipi.
 */
